...
const VALUES = [
  { t: 'אמינות ושקיפות', d: 'אנחנו לא מוכרים פוליסות — אנחנו בונים איתך את ההגנה שמתאימה לך באמת.' },
  { t: 'ליווי בתביעות', d: 'ההצלחות הגדולות שלנו נמדדות מול חברות הביטוח, ברגעים שבאמת חשובים.' },
  { t: 'זמינות מלאה', d: 'כשפונים אלינו — מקבלים תשובה, מקבלים שירות, ומקבלים צוות שנלחם לצידך.' },
];
    ...
    >
        ...
        <div style={{ maxWidth: 1080, margin: '0 auto', position: 'relative' }}>
          <div className="u360-rise" style={{ maxWidth: 720 }}>
            ...
            <p style={{ fontSize: 'clamp(17px, 2.2vw, 21px)', color: C.body, lineHeight: 1.6, margin: '22px 0 30px', maxWidth: 600 }}>
              ביטוח טוב הוא לא עוד פוליסה בתיק — הוא שקט נפשי אמיתי. אנחנו מקשיבים, מבינים את הצרכים שלך,
              ובונים איתך הגנה פיננסית מדויקת. כשצריך אותנו, אנחנו תמיד כאן.
            </p>
            <CTAButtons />
      ...
      <Section bg={SURFACE} id="services">
        <div style={{ textAlign: 'center', marginBottom: 44 }}>
          ...
          <p style={{ color: C.body, fontSize: 18, marginTop: 12, maxWidth: 620, marginInline: 'auto' }}>
            לקוח שמגיע אלינו מקבל מענה מלא: ביטוח, חיסכון ופנסיה — הכול במקום אחד, מותאם אישית.
          </p>
        </div>
        <div
          style={{
      ...
      <Section id="about">
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 48, alignItems: 'center' }}>
          <div>
            <Eyebrow>הגישה שלנו</Eyebrow>
            <H2>אנחנו לא מוכרים פוליסות — אנחנו בונים הגנה</H2>
            <p style={{ color: C.body, fontSize: 18, lineHeight: 1.7, margin: '18px 0' }}>
              לאורך הדרך ליווינו אלפי לקוחות — משפחות, עצמאים, בעלי עסקים וחברות — ועזרנו להם
              לבנות הגנה אמיתית, מותאמת אישית לחייהם. כל פתרון מותאם אישית, כל שאלה מקבלת מענה,
              וכל לקוח יודע שיש לו צוות שעומד לצידו גם ברגעים הקשים ביותר.
            </p>
            <p style={{ color: C.body, fontSize: 18, lineHeight: 1.7 }}>
              ההצלחות הגדולות ביותר שלנו הן בליווי תביעות מול חברות הביטוח ובסיוע ללקוחות שנקלעו
        ...
        <div style={{ marginTop: 48 }}>
          <div style={{ fontWeight: 800, fontSize: 20, color: C.heading, marginBottom: 18 }}>מה אנחנו עושים בשבילך</div>
